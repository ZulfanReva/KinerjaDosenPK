    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.datajabatan.create') }}"
                                            ...
                                            <tr>
                                                <td class="text-start">
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">{{ $jabatan->nama_jabatan }}</h6>
                                                ...
                                                <td class="align-middle text-center">
                                                    <button class="btn btn-sm bg-gradient-danger me-2"
                                                        onclick="hapusData({{ $jabatan->id }})" data-bs-toggle="modal"
        ...
        <script>
            ...
            document.getElementById('confirmDeleteBtn').onclick = () => {
                ...
                form.method = 'POST';
                form.action = `/admin/datajabatan/${selectedDataId}`; // Sesuaikan dengan route resource
