            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Data Periode
                        </li>
                    </ol>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="p-4">
                                ...
                                <form id="formContainer" method="POST" action="{{ route('admin.dataperiode.store') }}"
                                    ...
                                    <div class="d-flex justify-content-between mt-4">
                                        <div class="d-flex" style="gap: 10px;">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary"
                                                onclick="window.location.href='{{ route('admin.dataperiode.index') }}'">Kembali</button>
                                        </div>
