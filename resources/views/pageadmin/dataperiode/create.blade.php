...
<x-headeradmin :title="'Tambah Data Periode | E-Kinerja UMBJM'" />
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Data Periode</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Selamat Datang di halaman Tambah Data Periode</h6>
        </nav>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="p-4">
                ...
                <form id="formContainer" method="POST" action="{{ route('admin.dataperiode.store') }}" enctype="multipart/form-data">
                  @csrf
                  <div id="formGroup">
                  ...
                  <div class="d-flex justify-content-between mt-4">
                    ...
                    <div class="d-flex" style="gap: 10px;"> <!-- Menambahkan jarak menggunakan gap -->
                        ...
                        <button type="button " class="btn btn-outline-secondary" onclick="window.location.href='{{ route('admin.dataperiode.index') }}'">Kembali</button>
                    </div>
    ...
    <script>
      ...
      formContainer.addEventListener('submit', function (event) {
          ...
          // Mengambil semua input dengan nama "nama_periode[]"
          const periodeInputs = document.querySelectorAll('input[name="nama_periode[]"]');
          let periodeData = [];
          ...
          periodeInputs.forEach(input => {
              ...
              periodeData.push(input.value);
          });

          // Buat objek data untuk dikirim
          const data = {
              nama_periode: periodeData,
          };

          // Kirim data ke server menggunakan fetch
          fetch("{{ route('admin.dataperiode.store') }}", {
              method: "POST",
              headers: {
          ...
          .then(data => {
              ...
              alert("Data Periode berhasil disimpan!"); // Pesan sukses tambahan
              window.location.href = "{{ route('admin.dataperiode.index') }}"; // Redirect ke halaman index
          })
          .catch(error => {
