    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.dataperiode.create') }}"
                                    ...
                                    <thead>
                                        <tr>
                                            <th
                                                ...
                                                <a href="{{ route('admin.dataperiode.index', ['sort' => $sortOrder === 'asc' ? 'desc' : 'asc']) }}"
                                                ...
                                                <td class="text-start">
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">{{ $periode->nama_periode }}</h6>
                                                            <!-- Menampilkan nama periode -->
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <button class="btn btn-sm bg-gradient-danger me-2"
                                                        onclick="hapusData({{ $periode->id }})" data-bs-toggle="modal"
                                                        title="Hapus" data-bs-target="#confirmDeleteModal">
        ...
        <script>
            ...
            document.getElementById('confirmDeleteBtn').onclick = () => {
                ...
                form.method = 'POST';
                form.action = `/admin/dataperiode/${selectedDataId}`; // Sesuaikan dengan route resource
