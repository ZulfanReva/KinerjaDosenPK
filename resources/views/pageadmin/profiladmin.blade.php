    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid">
            <div class="page-header min-height-300 border-radius-xl mt-4"
                style="background-image: url('../assets/foto/bgprofil.png'); background-position-y: 50%;">
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative bg-gradient-info">
                            <img src="../assets/foto/profiladmin.png" alt="profile_image"
        ...
        <div class="modal fade" id="editPasswordModal" tabindex="-1" aria-labelledby="editPasswordModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('admin.profil.update.password') }}" id="passwordForm">
                        @csrf
                        @method('PUT')
        ...
        <script>
            ...
            document.getElementById('passwordForm').addEventListener('submit', function(event) {
                ...
                fetch("{{ route('admin.profil.update.password') }}", {
                        method: 'POST',
                        body: formData,
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            setTimeout(() => {
                                window.location.href = @json(route('admin.profil.index'));
                            }, 500);
                        } else {
